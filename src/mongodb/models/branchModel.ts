...
export interface IBranch {
	...
	title: string;
	branchId: string;
	country: string; // "Россия" или "Монголия"
	adress: string;
	city: string;
	zip_code: string;
	workTime: {
...
const branchShema = new Schema<IBranchDocument>(
	{
		...
		country: { type: String, required: true }, // Страна отделения: "Россия" или "Монголия"
...
export const BranchModel: Model<IBranchDocument> = models?.Branch || model<IBranchDocument>("Branch", branchShema);
